        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InfoLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    NameDetailed = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metric = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, 5, 3, "AMD Ryzen 5 5600X", "AMD Ryzen 5 5600X 3.7 GHz 6-Core Processor", 500.00m },
                    { 4, 5, 3, "AMD Ryzen 7 7800X3D", "AMD Ryzen 7 7800X3D 4.2 GHz 8-Core Processor", 500.00m },
                    { 5, 5, 4, "Intel Core i7-13700K", "Intel Core i7-13700K 3.4 GHz 16-Core Processor", 500.00m },
                    { 6, 5, 3, "AMD Ryzen 7 5800X", "AMD Ryzen 7 5800X 3.8 GHz 8-Core Processor", 500.00m },
                    { 7, 6, 5, "Cooler Master Hyper 212 Black Edition", "Cooler Master Hyper 212 Black Edition 42 CFM CPU Cooler", 500.00m },
                    { 8, 6, 5, "Cooler Master MASTERLIQUID ML240L RGB V2", "Cooler Master MASTERLIQUID ML240L RGB V2 65.59 CFM Liquid CPU Cooler", 500.00m },
                    { 9, 6, 6, "be quiet! Dark Rock Pro 4", "be quiet! Dark Rock Pro 4 50.5 CFM CPU Cooler", 500.00m },
                    { 10, 6, 7, "Corsair iCUE H150i ELITE CAPELLIX XT", "Corsair iCUE H150i ELITE CAPELLIX XT 65.57 CFM Liquid CPU Cooler", 500.00m },
                    { 11, 7, 8, "MSI B550 GAMING GEN3", "MSI B550 GAMING GEN3 ATX AM4 Motherboard", 500.00m },
                    { 12, 7, 9, "Gigabyte B650 AORUS ELITE AX", "Gigabyte B650 AORUS ELITE AX ATX AM5 Motherboard", 500.00m },
                    { 13, 7, 8, "MSI MAG B550 TOMAHAWK", "MSI MAG B550 TOMAHAWK ATX AM4 Motherboard", 500.00m },
                    { 14, 7, 9, "Gigabyte Z790 AORUS ELITE AX", "Gigabyte Z790 AORUS ELITE AX ATX LGA1700 Motherboard", 500.00m },
                    { 15, 8, 7, "Corsair Vengeance LPX 16 GB", "Corsair Vengeance LPX 16 GB (2 x 8 GB) DDR4-3200 CL16 Memory", 500.00m },
                    { 16, 8, 7, "Corsair Vengeance 32 GB", "Corsair Vengeance 32 GB (2 x 16 GB) DDR5-5600 CL36 Memory", 500.00m },
                    { 17, 8, 7, "Corsair Vengeance RGB Pro 32 GB", "Corsair Vengeance RGB Pro 32 GB (2 x 16 GB) DDR4-3600 CL18 Memory", 500.00m },
                    { 18, 8, 10, "G.Skill Trident Z5 RGB 32 GB", "G.Skill Trident Z5 RGB 32 GB (2 x 16 GB) DDR5-6000 CL36 Memory", 500.00m },
                    { 19, 9, 11, "Samsung 980 Pro", "Samsung 980 Pro 2 TB M.2-2280 PCIe 4.0 X4 NVME Solid State Drive", 500.00m },
                    { 20, 9, 12, "Seagate Barracuda Compute", "Seagate Barracuda Compute 2 TB 3.5\" 7200 RPM Internal Hard Drive", 500.00m },
                    { 21, 9, 13, "Kingston A400", "Kingston A400 240 GB 2.5\" Solid State Drive", 500.00m },
                    { 22, 9, 14, "Crucial P3", "Crucial P3 4 TB M.2-2280 PCIe 3.0 X4 NVME Solid State Drive", 500.00m },
                    { 23, 10, 8, "MSI GeForce RTX 3060 Ventus 2X 12G", "MSI GeForce RTX 3060 Ventus 2X 12G GeForce RTX 3060 12GB 12 GB Video Card", 500.00m },
                    { 24, 10, 9, "Gigabyte WINDFORCE OC", "Gigabyte WINDFORCE OC GeForce RTX 4070 12 GB Video Card", 500.00m },
                    { 25, 10, 15, "Asus ROG STRIX GAMING OC", "Asus ROG STRIX GAMING OC GeForce RTX 4090 24 GB Video Card", 500.00m },
                    { 26, 10, 8, "MSI RTX 3060 Ventus 3X 12G OC", "MSI RTX 3060 Ventus 3X 12G OC GeForce RTX 3060 12GB 12 GB Video Card", 500.00m },
                    { 27, 11, 7, "Corsair RM750e (2023)", "Corsair RM750e (2023) 750 W 80+ Gold Certified Fully Modular ATX Power Supply", 500.00m },
                    { 28, 11, 16, "Thermaltake Toughpower GX2", "Thermaltake Toughpower GX2 600 W 80+ Gold Certified ATX Power Supply", 500.00m },
                    { 29, 11, 8, "MSI MPG A650GF", "MSI MPG A650GF 650 W 80+ Gold Certified Fully Modular ATX Power Supply", 500.00m },
                    { 30, 11, 17, "EVGA 500 W1", "EVGA 500 W1 500 W 80+ Certified ATX Power Supply", 500.00m },
                    { 31, 12, 18, "Deepcool CC560", "Deepcool CC560 ATX Mid Tower Case", 500.00m },
                    { 32, 12, 19, "NZXT H5 Flow", "NZXT H5 Flow ATX Mid Tower Case", 500.00m },
                    { 33, 12, 20, "Lian Li O11 Dynamic EVO", "Lian Li O11 Dynamic EVO ATX Mid Tower Case", 500.00m },
                    { 34, 12, 21, "Fractal Design North", "Fractal Design North ATX Mid Tower Case", 500.00m },
                    { 35, 13, 22, "HP HyperX Cloud II", "HP HyperX Cloud II 7.1 Channel Headset", 500.00m },
                    { 36, 13, 23, "Razer BlackShark V2 X", "Razer BlackShark V2 X 7.1 Channel Headset", 500.00m },
                    { 37, 13, 24, "Logitech Pro X", "Logitech Pro X 7.1 Channel Headset", 500.00m },
                    { 38, 13, 23, "Razer Kraken Kitty", "Razer Kraken Kitty Headset", 500.00m },
                    { 39, 14, 7, "Corsair K60 RGB Pro", "Corsair K60 RGB Pro Wired Gaming Keyboard", 500.00m },
                    { 40, 14, 24, "Logitech K120", "Logitech K120 Wired Standard Keyboard", 500.00m },
                    { 41, 14, 23, "Razer Huntsman Mini", "Razer Huntsman Mini RGB Wired Mini Keyboard", 500.00m },
                    { 42, 14, 23, "Razer BlackWidow V3", "Razer BlackWidow V3 RGB Wired Gaming Keyboard", 500.00m },
                    { 43, 15, 24, "Logitech G502 HERO", "Logitech G502 HERO Wired Optical Mouse", 500.00m },
                    { 44, 15, 23, "Razer Basilisk V3", "Razer Basilisk V3 Wired Optical Mouse", 500.00m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 45, 15, 23, "Razer DeathAdder Essential", "Razer DeathAdder Essential Wired Optical Mouse", 500.00m },
                    { 46, 15, 23, "Razer Viper Mini", "Razer Viper Mini Wired Optical Mouse", 500.00m },
                    { 47, 16, 24, "Logitech Z200", "Logitech Z200 10 W Speakers", 500.00m },
                    { 48, 16, 24, "Logitech Z906", "Logitech Z906 500 W 5.1-Channel Speakers", 500.00m },
                    { 49, 16, 23, "Razer Leviathan V2", "Razer Leviathan V2 65 W 2.1-Channel Speakers", 500.00m },
                    { 50, 16, 25, "Creative Labs Creative Stage V2", "Creative Labs Creative Stage V2 80 W 2.1-Channel Speakers", 500.00m },
                    { 51, 17, 24, "Logitech BRIO Ultra HD Pro", "Logitech BRIO Ultra HD Pro Webcam", 500.00m },
                    { 52, 17, 23, "Razer Kiyo Pro Ultra", "Razer Kiyo Pro Ultra Webcam", 500.00m },
                    { 53, 18, 15, "Asus TUF Gaming VG27AQ", "Asus TUF Gaming VG27AQ 27.0\" 2560 x 1440 165 Hz Monitor", 500.00m },
                    { 54, 18, 11, "Samsung Odyssey G7", "Samsung Odyssey G7 27.0\" 2560 x 1440 240 Hz Curved Monitor", 500.00m },
                    { 55, 18, 26, "AOC C27G2Z", "AOC C27G2Z 27.0\" 1920 x 1080 240 Hz Curved Monitor", 500.00m },
                    { 56, 17, 24, "Logitech C270", "Logitech C270 Webcam", 500.00m },
                    { 57, 17, 23, "Razer Kiyo", "Razer Kiyo Webcam", 500.00m },
                    { 58, 18, 27, "LG UltraGear", "LG UltraGear 27.0\" 2560 x 1440 165 Hz Monitor", 500.00m }
                });
