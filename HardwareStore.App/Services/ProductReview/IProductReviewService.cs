namespace HardwareStore.App.Services.ProductReview
{
    ...
    public interface IProductReviewService
    {
        ...
        Task CreateReviewAsync(string userId, string content, int? rating, int productId);
        Task<ServiceResult> DeleteReviewAsync(int reviewId, bool trueDelete = false);
        Task<ServiceResult> EditReviewAsync(string userId, int reviewId, string content, int rating);
